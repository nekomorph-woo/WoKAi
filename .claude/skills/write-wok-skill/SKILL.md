...
| **Marketplace 插件** | `plugins/<name>/` | 完整三层结构 | 面向外部用户分发的能力 |
...
| 结构 | 三层目录（plugin.json + commands/ + skills/） | 最小结构（SKILL.md） |

### Good Case

```
✅ plugins/fast-commit/              → 面向用户的 commit 工具，marketplace 分发
